...
if __name__ == '__main__':
    ...
    transformer = transforms.Compose([transforms.Resize((SIZE_H, SIZE_W)),        # scaling images to fixed size
    ...
    pd.DataFrame(data={'class': np.int32(scores > 0.5)}).to_csv('dataset/preds.csv', index=False)
